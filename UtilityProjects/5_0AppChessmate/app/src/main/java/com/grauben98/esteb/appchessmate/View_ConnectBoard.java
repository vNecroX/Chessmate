...
public class View_ConnectBoard extends AppCompatActivity {
    ...
    //Variables
        ...
        public static boolean fromFragment = false;
        //String
        public String deviceMAC = "00:21:13:00:F1:55";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.view_connectboard);
            ...
            public void onClick(View v) {
                if(bluetoothAdapter.isEnabled()){
                    ...
                    if(View_ConnectBoard.fConnected || View_BluetoothDevice.fConnected){
                        View_MainInterface.avoidFragmentBoardConn = true;
    ...
    public void gotoMainInterface(){
        Intent intentMainInterface = new Intent(this, View_MainInterface.class);
